...
<div class='codebox'>
    <form id='bookmarks' method='POST' action='${ontPostUrl}'>
        ...
        <select id='uri-bookmark' name='uri' style='width:80%; margin-top: 0;'>
            <c:forEach items="${bookmarks}" var="bookmark">
                <option value='${bookmark.value}'>${bookmark.key} (${bookmark.value})</option>
            </c:forEach>
        </select>
        <input name='action' type='submit' value='load' />
    </form>
    <form id='load' method='POST' action='${ontPostUrl}'>
