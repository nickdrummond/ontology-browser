...
public class SearchServiceImpl implements SearchService {
    ...
    @Override public List<OWLEntity> findByName(final String input, final OWLHTMLKit kit) {
    ...
    @Override public List<AxiomWithMetadata> findByAnnotation(@Nonnull String value,
    ...
    @Override public Set<OWLEntity> getEntities(IRI iri, OWLHTMLKit kit) {
