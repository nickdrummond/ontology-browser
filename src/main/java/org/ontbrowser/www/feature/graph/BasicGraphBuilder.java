...
public class BasicGraphBuilder implements GraphBuilder {
    ...
    private static final Logger log = LoggerFactory.getLogger(BasicGraphBuilder.class);
    ...
    public BasicGraphBuilder(GraphDescriptor descr) {
        this.descr = descr;
    ...
    // Add arbitrary edges
    public BasicGraphBuilder add(Graph.Edge edge) {
        this.edges.add(edge);
        return this;
    }
